...
const Hero = () => {
  ...
  return (
    <div className="py-4 sm:py-8 lg:py-16 px-4 md:px-8">
      <div className="mx-auto px-2 sm:px-4 lg:px-12">
        {/* Main Heading */}
        <div className="mb-4 sm:mb-8">
          <h1 className="text-4xl sm:text-6xl lg:text-[120px] uppercase text-center font-black tracking-[-0.05em] leading-[0.9]">
            <span className="text-[#232321]">DO IT</span>
            <span className="text-[#4a69e2] ml-1 sm:ml-2 lg:ml-4">RIGHT</span>
          </h1>
        </div>
